...
<div class="banner">
  <div class="container">
    ...
    <div class="home_button_sectation">
      <div class="col-lg-4"> <a href="<?php echo site_url('submit-review') ?>" class="btn theme_btn"><img src="<?php bloginfo('template_url'); ?>/assets/images/icon_submit_review.png"> submit review</a> </div>
